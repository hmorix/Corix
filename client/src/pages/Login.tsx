  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-transcendent px-4 py-12 relative overflow-hidden">
      ...
      <div className="pointer-events-none" aria-hidden>
        <div className="glow-orb glow-orb-primary" style={{ top: "-150px", left: "-100px", opacity: 0.3 }} />
        <div className="glow-orb glow-orb-secondary" style={{ bottom: "-100px", right: "-80px" }} />
      ...
      <div className="w-full max-w-md relative z-10 page-enter">
        ...
        <div className="glass-card p-7 sm:p-9">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="serif-heading text-2xl sm:text-3xl mb-1.5">Welcome back</h1>
            <p className="sans-secondary text-sm text-center">
              Sign in to your Corix account
            </p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="pl-10 h-11 rounded-xl border-border bg-input"
                  disabled={isLoading}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-xs text-accent hover:opacity-80 transition-opacity font-medium">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <a href="/signup" className="text-accent font-semibold hover:opacity-80 transition-opacity">
              Sign up free
            </a>
          </p>
        </div>
